...
void*ThreadEntry(void*arg)
{
	...
	// for (int i = 0; i < 128; i++) {
	// 	printf("%02X ",tUartData.m_rec_array[i]);
	// }
	printf("\n");
	memset(tUartData.m_rec_array,0,sizeof(*tUartData.m_rec_array));
	usleep(50000);
...
int main()
{
	...
	}else
	{
		...
		{    
			...
			// printf("%x\n",array);
			// Read_Hand_Data(0x01);
			Write_Hand_Angle_Position(0x01,1800,1800,1800,1800,1800,1800);

			// Read_Hand_Register_Data(0x01,0x6400,0x0C);
			// switch(array)
			// {
			// 	case 0:
			// 	{
			...
			// 	case 1:
			// 	{
			// 		Write_Hand_Angle(0x01,800,800,800,800,800,800);
			// 		break;
			// 	}
			// 	case 2:
			// 	{
			// 		Write_Hand_Angle(0x01,200,200,200,200,400,600);
			// 		break;
			// 	}
			// }
			// printf("%c\n",tUartData.m_send_array);
			// printf("-----------------------------------------------------------\n");
			// for (int i = 0; i < 128; i++) {
			...
			sleep(3);
			Write_Hand_Angle_Position(0x01,10,200,200,200,400,400);
			write(fd,tUartData.m_send_array,tUartData.m_tx_len);
			sleep(3);
